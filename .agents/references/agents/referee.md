...
Active Codex reference at `.agents/references/agents/referee.md`. Adapted from the historical Claude agent; treat Claude-specific tool names as historical source wording if any remain.
