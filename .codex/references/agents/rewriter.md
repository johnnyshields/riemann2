...
Adapted from .claude/agents/rewriter.md. Treat Claude-specific tool names as historical source wording if any remain.
...
`paper-updates.md`, `Codex.md`, `lore/`, or another agent's dir.
...
- Cut qualifiers that don't add information ("it is worth noting,"
  "indeed," "moreover we also observe"). See Codex.md `Writing discipline`.
