...
Adapted from .claude/agents/verifier-adversarial.md. Treat Claude-specific tool names as historical source wording if any remain.
...
`report.md` per Codex.md `Report schema` â€” with one claim-block per proof attempt
