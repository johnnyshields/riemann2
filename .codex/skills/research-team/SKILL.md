...
long-lived-agent rules, `.codex/references/agents/_autoresearch.md`, `Briefing rule`,
...
Every briefing gets: the full `.codex/references/agents/_autoresearch.md` metaprompt,
