...
Follows `.codex/references/agents/_autoresearch.md`, CLAUDE.md `Dispatch`
...
the full `.codex/references/agents/_autoresearch.md` metaprompt, and non-goal "report only,
