...
- **Next:** redelegate toward the smallest positive theorem: construct the actual exceptional-divisor quotient class `[R]` or prove its state-locality/descent, then merger normalization.
