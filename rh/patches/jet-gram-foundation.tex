...
%     Hardy/source-transfer information.
%
% Closes:
...
Hardy/source-energy input is used in
Sections~\ref{sec:local-kernel-and-jet-normalization}--\ref{sec:jet-limit-local-blocks}.
Such conditions are imposed only in the later sections where actual-zeta
transverse suppression or source-energy transfer is consumed.
\end{remark}
...
\(q'' - 6q + 2q^3\), nor does it supply Hardy/source-transfer
information.
\end{remark}
