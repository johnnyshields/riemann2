...
in the same scalar channel as the toy lower bound.  All occurrences of
\(\Pi_\trans\) in this section are therefore understood as two-point
objects on \(M_2(\mathbb R)\).  This section does not define the
four-point projection \(\Pi_\trans^{(4)}\).
