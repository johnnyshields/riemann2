...
Symbolic verification: \texttt{rh/sympy/sec-jet-limit-local-blocks.py}.
\end{remark}
...
Numerical sanity checks at heights along a dyadic ladder:
\texttt{rh/simulation/sec-jet-limit-local-blocks.py}.
\end{remark}
