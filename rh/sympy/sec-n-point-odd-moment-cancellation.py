...
def verify_coefficient_identities(N_values=(1, 2, 3, 4, 5, 6, 7, 8)):
    print("=" * 70)
    ...
    for N in N_values:
        ...
        if N >= 2:
            ...
            print("        no low odd moment cancellation is asserted for N=1.")
    print()
...
def verify_mu_hat_parity(N_values=(1, 2, 3, 4, 5)):
    print("=" * 70)
    ...
    for N in N_values:
        ...
        if N >= 2:
            ...
            print(f"  N={N}: mu_hat(0) = 1; no low odd derivatives are required to vanish;")
...
def verify_convolution_parity(N_values=(1, 2, 3, 4, 5)):
    print("=" * 70)
    ...
    for N in N_values:
        ...
        if N >= 2:
            ...
            print(f"  N={N}: convolution range is empty; no low odd derivative is asserted,")
...
def verify_A_N_difference_identity(N_values=(1, 2, 3, 4, 5)):
    print("=" * 70)
    ...
    print("         confirmed for tested N, including the edge case N=1.")
...
def verify_alternating_sign_pattern(N_values=(1, 2, 3, 4, 5, 6, 7, 8)):
