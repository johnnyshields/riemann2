...
- Dirty working-tree files outside this handoff remain: `.agents/references/agents/fixer.md`, `.agents/skills/chat-backup/SKILL.md`, `.agents/skills/paper-biblio/SKILL.md`, and `CLAUDE.md`. They were not part of the UV-010 capture.
