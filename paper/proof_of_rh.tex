...
The first-order generator map is now explicit, but the proof that its image is
all of $M_2(\mathbf C)$ under the stated generic nondegeneracy assumptions
should still be audited as a separate finite-dimensional linear-algebra check.
\end{remark}
