...
here is therefore not a gap in the local compact first-zero argument, but the
separate task of proving zero-capture for the tangent-separator kernel
$K(s,t)$ under the turning-boundary hypotheses.
\end{remark}
