...
- **Exact refs**: `quantum/paper/jet_gram_quantum_note.md:55-80`; `quantum/paper/jet_gram_quantum_note.md:343-347`; `quantum/paper/jet_gram_quantum_note.md:356-372`; `quantum/findings.md:27-34`; `quantum/20260423-201939-attack-krylov/reports/gap-krylov-theorem.md:3-38`; `quantum/20260424-001425-attack-commutator-metric/notes/coordinator-brief.md:3-12`.
