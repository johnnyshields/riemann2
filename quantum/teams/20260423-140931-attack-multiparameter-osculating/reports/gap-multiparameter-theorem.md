...
- **Exact refs**: `quantum/teams/20260423-140931-attack-multiparameter-osculating/notes/coordinator-brief.md:3-14`; `quantum/paper/jet_gram_quantum_note.md:174-247`; `quantum/findings.md:46-58`; `quantum/teams/20260423-140111-attack-transport-free-subspaces/reports/gap-transport-free-subspaces.md:3-23`.
