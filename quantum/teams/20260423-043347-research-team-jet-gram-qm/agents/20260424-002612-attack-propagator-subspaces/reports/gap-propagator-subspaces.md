...
- **Exact refs**: `quantum/paper/jet_gram_quantum_note.md:294-358`; `quantum/paper/jet_gram_quantum_note.md:368-389`; `quantum/findings.md:84-99`; `quantum/teams/20260423-201939-attack-krylov/reports/gap-krylov-theorem.md:3-41`; `quantum/teams/20260424-002612-attack-propagator-subspaces/notes/coordinator-brief.md:3-14`.
