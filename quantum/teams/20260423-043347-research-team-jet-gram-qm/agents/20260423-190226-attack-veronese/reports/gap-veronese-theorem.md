...
- **Exact refs**: `quantum/paper/jet_gram_quantum_note.md:318-340`; `quantum/paper/jet_gram_quantum_note.md:382-404`; `quantum/paper/jet_gram_quantum_note.md:501-545`; `quantum/findings.md:53-64`; `quantum/findings.md:115-131`; `quantum/teams/20260423-132614-attack-richer-family/reports/gap-richer-family.md:3-29`; `quantum/teams/20260423-135052-attack-quartit-osculating/reports/gap-quartit-principal-angles.md:3-43`; `quantum/teams/20260423-190226-attack-veronese/notes/coordinator-brief.md:3-13`.
