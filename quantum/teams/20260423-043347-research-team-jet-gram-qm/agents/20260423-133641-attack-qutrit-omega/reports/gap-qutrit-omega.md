...
- **Exact refs**: `quantum/paper/jet_gram_quantum_note.md:37-50`; `quantum/paper/jet_gram_quantum_note.md:107-152`; `quantum/paper/jet_gram_quantum_note.md:178-247`; `quantum/paper/jet_gram_quantum_note.md:300-315`; `quantum/findings.md:85-90`; `quantum/findings.md:115-122`; `quantum/teams/20260423-132614-attack-richer-family/reports/gap-richer-family.md:3-29`; `quantum/teams/20260423-133641-attack-qutrit-omega/notes/coordinator-brief.md:3-13`.
