...
- **Current best:** The safe canonical core is the subspace/operator package:
  ...
  repeated-spectrum no-go, and finite-dimensional CS completeness.
...
- **Next:** Per user redirection on 2026-04-24, do not default to a 3+3+2
  roster. Promote the verified UV-012 theorem, then return to the remaining
  open UVs.
