...
| `20260424-192735-verifier-natural-protocol` | UV-014 | Adversarially test the reflection/phase-estimation protocol, access assumptions, exceptional sectors, and overclaim boundaries. | running | Briefed against `agents/20260424-192133-gap-natural-protocol/report.md` and operational/Krylov/Kato reports. | Await report; accept, revise, or keep UV-014 open. | Verification required before changing UV-014 proof state. |
