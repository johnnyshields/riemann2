...
- **Exact refs**: `quantum/paper/jet_gram_quantum_note.md:248-277`; `quantum/paper/jet_gram_quantum_note.md:334-339`; `quantum/findings.md:50-61,158-166`; `quantum/20260423-140931-attack-multiparameter-osculating/reports/gap-multiparameter-theorem.md:3-26`; `quantum/20260423-234645-attack-covariant-jets/reports/gap-covariant-jets.md:3-31`; `quantum/20260423-235606-attack-multiparameter-covariant-jets/notes/coordinator-brief.md:3-14`.
