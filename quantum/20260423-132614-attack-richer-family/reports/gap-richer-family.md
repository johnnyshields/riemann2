...
- **Exact refs**: `quantum/paper/jet_gram_quantum_note.md:225-247`; `quantum/findings.md:78-82,99-113`; `quantum/20260423-131550-attack-first-jet-singular-values/reports/gap-singular-values.md:3-9`; `quantum/20260423-132614-attack-richer-family/notes/coordinator-brief.md:3-14`.
