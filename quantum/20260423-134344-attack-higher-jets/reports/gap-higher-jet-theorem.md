...
- **Exact refs**: `quantum/20260423-043347-research-team-jet-gram-qm/reports/gap-closer-gauge.md:3-9`; `quantum/20260423-051725-attack-jet-qgt-core/reports/gap-matrix-vs-subspace.md:3-9`; `quantum/findings.md:35-49,95-124`; `quantum/paper/jet_gram_quantum_note.md:174-247`; `quantum/20260423-134344-attack-higher-jets/notes/coordinator-brief.md:3-16`.
